...
class App extends Component {
  ...
  handleWinner(){
    switch(this.checkWin(this.state.board)){
      case ai:
        this.setState({msg:"AI je pobedio",newGame:true});
        break;
      case human:
        this.setState({msg:"Vi ste pobedili",newGame:true});
        break;
      case 'TIE':
        this.setState({msg:"Nereseno",newGame:true});
        break;
      default:
    }
  }
    ...
    return (
      <div >
        ...
        <Container component="main"  maxWidth="sm">
					<Typography style={{textAlign: 'center'}}variant="h2" component="h1" gutterBottom>
            XO
          </Typography>
            <Typography style={{color:"black",textAlign:"center"}} variant="h4" component="h2" >
              {this.state.msg}
            </Typography>
          {this.state.newGame?<Button style={style.btn} variant="contained" color="primary" onClick={this.startNewGame} >Ponovo?</Button>:''}
          <div>
            <Board
